...
c                if (inp%model == 1) then
                  calcparm(irf,jj) = .false.
c                else
c                  calcparm(irf,jj) = readflag(irf)
c                endif  
              else
...
cJ.Peng--------2014-10-27--------------------------
c            calcparm(10,jj) = .TRUE.
c            calcparm(11,jj) = .TRUE.
c            if (inp%model == 1) then
...
cJ.Peng---12/13/2016------------------
      ...
      integer   ig2_lev_11_cmcd(nparms),ig2_lev_val_cmcd(nparms)
...
c      data ig2_lev_val_cmcd /85,7,85,85,7,7,85,7,0
c     &                         ,10,10,5,5,40100/
cJ.Peng----10/15/2019---------------------------
      data ig2_lev_11_cmcd /-3,-4,-3,-3,-4,-4,-3,-4,-9999,0,0,-4,-4,0/
      data ig2_lev_val_cmcd /85,7,85,85,7,7,85,7,-9999
     &                         ,10,10,5,5,40100/
...
cJ.Peng---& ,krec,pabbrev,pdt_4p0_vert_level/100,gfld%idsect(6)
