...
ctmwc              endif
              ...
              call bilin_int_uneven (targlat,targlon
     &            ,dx,dy,imax,jmax,trkrinfo,level,'u',xintrp_u,ibiret1)

              call bilin_int_uneven (targlat,targlon
     &            ,dx,dy,imax,jmax,trkrinfo,level,'v',xintrp_v,ibiret2)
...
cPENG added bug fixed on 04/28/2016--------------------------
      if (cosanga < -1.0) then
        cosanga = -1.0
      endif
cPENG added on 04/28/2016--------------------------
...
cPENG  04/18/2018 for CMC Det. and CMC ensemble data
      integer   ig2_lev_11_cmc(nreadparms),ig2_lev_val_cmc(nreadparms)
...
c      integer   cpsig2_lev_typ(nlevs_cps),cpsig2_lev_val(nlevs_cps)
cPENG-------
...
cPENG  04/18/2018 for CMC Det. and CMC ensemble data
     ...
     &                     ,-4,-4,0/
      data ig2_lev_val_cmc/85,7,85,85,7,7,85,7,0,10,10,5,5,40100
     &                     ,5,2,-9999/

c      data ig2_lev_11_cmcd /-3,-4,-3,-3,-4,-4,-3,-4,0,0,0,-4,-4,0
c     &                     ,-4,-4,0/
c      data ig2_lev_val_cmcd /85,7,85,85,7,7,85,7,0,10,10,5,5,40100
c     &                       ,5,2,-9999/
cJ.Peng----10/15/2019---------------------------
      data ig2_lev_11_cmcd /-3,-4,-3,-3,-4,-4,-3,-4,-9999,0,0,-4,-4,0
     &                     ,-4,-4,0/
      data ig2_lev_val_cmcd /85,7,85,85,7,7,85,7,-9999,10,10,5,5,40100
     &                       ,5,2,-9999/
...
cPENG  04/18/2018  CMC Det. and CMC ensemble data
...
cPENG &            ,krec,pabbrev,pdt_4p0_vert_level/100,gfld%idsect(6)
            endif
     ...
     &                                           ,need_to_flip_lats)
                else if (jpdt(12) == 20000 .or. jpdt(12) == 2) then
...
c
c---------------------------------------------------------------------
      subroutine read_tcv_card1 (lucard,maxstorm,trkrinfo,numtcv,iret)
c
...
c
c-----------------------------------------------------------------------
      subroutine read_gen_vitals1(lgvcard,maxstorm,trkrinfo,numtcv,iret)
c
...
c     cmodel_type  character, 'global' or 'regional'
      ...
      integer    jnfix,jsfix,iefix,iwfix
...
c
      ...
      integer  iazim,ibiret1,imax,jmax,ix,jx,iclmret,imct
...
c     distance of 75 km from the center point....
      ...
      azimloop: do iazim = 1,numazim
        ...
        call bilin_int_uneven (targlat,targlon
     &      ,dx,dy,imax,jmax,trkrinfo,850,'m',xintrp_mask,ibiret1)
...
c
c-----------------------------------------------------------------------
c Added by JPENG 03/21/2018, regarding FTN compiler with FORT11/FORT31
...
c-----------------------------------------------------------------------
c Added by JPENG 03/21/2018, regarding FTN compiler with FORT12
...
c-----------------------------------------------------------------------
c Added by JPENG 03/21/2018, regarding FTN compiler with FORT14
